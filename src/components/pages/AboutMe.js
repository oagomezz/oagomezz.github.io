...
return(
  <div className="page-content">
    ...
    <div className="text-container">
      <h3> Biography
        <p className="aboutme">
          Welcome&#44; my name is Oscar Gomez&#44; and I am a Full Stack developer&#46; I am enthusiastic about applying my skillset to secure a job within the industry that will allow me to utilize my strength&#39;s to their fullest potential&#46;
        </p>
        <p className="aboutme">
